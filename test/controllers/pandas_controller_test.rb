...
class PandasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create panda" do
    assert_difference("Panda.count") do
      post pandas_url, params: { panda: { email: @panda.email, first_name: @panda.first_name, group: @panda.group, last_name: @panda.last_name } }
    end
  ...
  test "should update panda" do
    patch panda_url(@panda), params: { panda: { email: @panda.email, first_name: @panda.first_name, group: @panda.group, last_name: @panda.last_name } }
